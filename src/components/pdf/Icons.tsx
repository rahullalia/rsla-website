...
// All icons use currentColor for fill to inherit color from parent
...
export function RocketIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2.5c-1.76 0-3.5.59-4.9 1.68L2.93 8.35c-.59.47-.93 1.19-.93 1.96v5.38c0 .77.34 1.49.93 1.96l4.17 3.17C8.5 21.91 10.24 22.5 12 22.5s3.5-.59 4.9-1.68l4.17-3.17c.59-.47.93-1.19.93-1.96v-5.38c0-.77-.34-1.49-.93-1.96l-4.17-3.17C15.5 3.09 13.76 2.5 12 2.5zm0 15c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/>
    </svg>
  );
}
